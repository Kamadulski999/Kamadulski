    ...
    return(
        ...
        <div className="col-12 about-section">
            <p className='about-p m-2'>
                <span className="about-section-banner">
                    A New Direction
                </span><br></br><br></br><span>My academic training is in Organic Synthesis, specifically drug discovery. Unfortunately, that research is not a focus here in the St. Louis area. While most of the basic research into design and synthesis of new drugs is being conducted elsewhere, locally there are numerous manufacturing plants requiring Analytical Chemists to conduct Quality Control testing. I have found a lot of success in this role. However, it has left me uninspired and wanting to seek more creative pursuits.
